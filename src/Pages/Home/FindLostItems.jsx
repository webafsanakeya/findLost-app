...
const FindLostItems = () => {
  ...
  return (
    <div className="p-6 lg:p-12 bg-gray-50 dark:bg-gray-900">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 mb-4 text-center">
        Discover Lost & Found Treasures
      </h2>
      <p className="text-gray-600 dark:text-gray-300 sm:text-lg md:text-xl max-w-4xl mx-auto mb-10 text-center">
